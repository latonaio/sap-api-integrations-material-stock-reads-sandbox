...
以下の項目のうち、"Batch" ～ "WBSElementInternalID" は、/SAP_API_Output_Formatter/type.go 内 の Type MaterialStock {} による出力結果です。"cursor" ～ "time"は、golang-logging-library による 定型フォーマットの出力結果です。  
